...
class ServerVlessSave extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'network.required' => '网络类型不能为空',
            'network.in' => '网络类型不正确',
            'tls.required' => 'TLS 配置不能为空',
            'networkSettings.array' => '网络设置格式不正确',
            'ruleSettings.array' => '规则设置格式不正确',
            'tlsSettings.array' => 'TLS 设置格式不正确',
            'dnsSettings.array' => 'DNS 设置格式不正确'
        ];
    }
}