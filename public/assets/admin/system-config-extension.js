...
(function() {
    ...
    function findMenuContainer() {
        ...
        for (const ul of allUls) {
            ...
            for (const item of menuItems) {
                ...
                if (text.includes('用户显示') || text.includes('前端导航页') || text.includes('常用导航') || text.includes('福利导航')) {
     ...
     * 查找用户显示菜单项
     */
    function findUserDisplayMenuItem() {
    ...
    function insertSystemConfigMenuItem() {
        ...
        const userDisplayItem = findUserDisplayMenuItem();
        if (!userDisplayItem) {
            console.log('[系统配置管理扩展] 未找到参考菜单项，尝试插入到菜单末尾');
        ...
        // 在用户显示后面插入
        const systemConfigItem = createSystemConfigMenuItem();
        userDisplayItem.parentNode.insertBefore(systemConfigItem, userDisplayItem.nextSibling);
        menuInserted = true;
        
        console.log('[系统配置管理扩展] 菜单项已插入到用户显示后面');
        return true;
    }
